...
namespace Курсовик
{
    public partial class tank : Form
    {
        ...
        public DataTable selectTable()
        {
            ...
            DataTable data = new DataTable();
            data.Clear();
            string sql = String.Format("SELECT * FROM sklad WHERE Type = 'Military equipment' ");
            db.Openconnection();
        ...
        private void addPicture(int i, FlowLayoutPanel flw)
        {
            ...
            pb.Name = "pb" + i;
           // pb.Image = Image.FromFile("C:/Users/User/Desktop/rehc/Курсовик/Курсовик/Resources/tank.png");
        ...
        private void tank_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < data.Rows.Count; i++)
            {
                ...
                Console.WriteLine("Имя:" + flw_tank.Name);
                Console.WriteLine("Loc:" + flw_tank.Location);

            }
            flw_tank = null;
        }

        private void flw_tank_Paint(object sender, PaintEventArgs e)
        {
